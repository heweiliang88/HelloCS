...
<p align="center">
    ...
    <a title="coolapk" target="_blank" href="https://www.coolapk.com/u/787649"><img
...
- VsCode 管理代码 ==》 SourceTree 版本控制管理 ==》Postman 管理接口

学习流

- 学习 =》项目 =》复习 =》复述
- Typora 管理个人笔记 ==》 Xmind 管理思维导图 ==》 书籍管理：微信读书  ==》 Notion 管理读书笔记  ==》 阅读进度管理 Pocket 
...
数据结构与算法 => 设计模式 ==> 软件工程 => 计算机网络 => 计算机组成原理 => 操作系统
...
- [ ] [数据结构与算法基础（青岛大学-王卓）_哔哩哔哩_bilibili](https://www.bilibili.com/video/BV1nJ411V7bd?spm_id_from=333.337.search-card.all.click)
...
- [ ] [王道计算机考研 操作系统_哔哩哔哩_bilibili](https://www.bilibili.com/video/BV1YE411D7nH?spm_id_from=333.337.search-card.all.click)
...
git => html5 => css3 => javascript => ajax => jquery => es6 => typescript => vue => webpack => node => 微信小程序 => uniapp

js 数据结构与算法 => leetcode刷题 => 设计模式 => 软件工程 => 计算机网络 
...
- [Python思维导图](后端/Python.xmind)
- [Python笔记](后端/Python.md)

学习

- [x] [Python教程 - 廖雪峰的官方网站](https://www.liaoxuefeng.com/wiki/1016959663602400)  
